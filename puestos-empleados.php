...
<head>
    ...
    <title>Puestos de Empleados | MAUI</title>
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-mgrey" id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                        ...
                        <div class="col-lg-12 my-3">
                            <div class="card shadow-sm px-2">
                                <div class="card-header bg-white border-0 py-3 align-items-center justify-content-start d-flex flex-row">
                                    ...
                                    <h1 class="h3 m-0 font-weight-bold text-mprimary-100"> Puestos de Empleados</h1>

                                    <button class="btn btn-mprimary-100 mx-4 text-light" data-bs-toggle="modal" data-bs-target="#insertPuestoEmpleados">Agregar
                                        ...
                                        <table id="empleadostable" class="table datatable-basic table-hover display " style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Nombre</th>
                                                    <th>Descripción</th>
                                                    <th>App Administrador</th>
                                                    <th>App Supervisor</th>
                                                    <th>App </th>
                                                    <th>Web Administrador</th>
                                                    <th>Web Supervisor</th>
                                                    <th>Web Usuario</th>
                                                    <th></th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th class="filterhead">Descripción</th>
                                                    <th class="filterhead">App Administrador</th>
                                                    <th class="filterhead">App Supervisor</th>
                                                    <th class="filterhead">App </th>
                                                    <th class="filterhead">Web Administrador</th>
                                                    <th class="filterhead">Web Supervisor</th>
                                                    <th class="filterhead">Web Usuario</th>
                ...
                <!-- Modal -->
                <?php include 'modal/insert-puesto-empleados.php'; ?>
                <?php include 'modal/edit-puesto-empleados.php'; ?>
                <!-- /modal -->
            </div>
        </div>
    </div>
    ...
    <!--  Clientes -->
    <script src="js/datatables/datatables_puestos_empleados.js"></script>
    <script src="js/puestos_empleados.js?v=1"></script>
