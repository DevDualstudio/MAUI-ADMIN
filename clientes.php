...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-mgrey" id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                        ...
                        <div class="col-lg-12 my-3">
                            <div class="card shadow-sm px-2">
                                <div class="card-header bg-white border-0 py-3 align-items-center justify-content-start d-flex flex-row">
                                    ...
                                    <h1 class="h3 m-0 font-weight-bold text-mprimary-100">Clientes</h1>

                                    <button class="btn btn-mprimary-100 mx-4 text-light" data-bs-toggle="modal" data-bs-target="#insertCliente">Agregar
                                        <i class="fa-solid fa-plus mr-2"></i></button>
                                </div>
                                <div class="card-body">

                                    <div class="table-responsive">
                                        <table id="clientestable" class="table datatable-basic table-hover display " style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Nombre</th>
                ...
                <!-- Modal -->
                <?php include 'modal/insert-cliente.php'; ?>
                <?php include 'modal/edit-cliente.php'; ?>
                <!-- /modal -->
            </div>
        </div>
    </div>
    ...
    <script src="js/datatables/datatables_clientes.js"></script>
